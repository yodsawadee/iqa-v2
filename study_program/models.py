...
class AUN(models.Model):
    ...
    assessment_id = models.OneToOneField(AssessmentResult, on_delete=models.PROTECT, null=True)
    #code = models.CharField(max_length=200)
    #assessment_id = models.ForeignKey(AssessmentResult, on_delete=models.PROTECT, null=True)
...
class AvailableTime(models.Model):
    ...
    appointed_program = models.OneToOneField(StudyProgram, on_delete=models.PROTECT, null=True)
